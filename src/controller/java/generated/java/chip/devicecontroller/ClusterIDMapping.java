...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == AppleDeviceInformation.ID) {
            return new AppleDeviceInformation();
        }
    ...
    public static class AppleDeviceInformation implements BaseCluster {
        public static final long ID = 323615744L;
        public long getID() {
            return ID;
        }
